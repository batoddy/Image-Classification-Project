...
int main()
{
    ...
    printf("SGD_CAR_TEST\t");
    test_model(sgd_weights[0], img_mtrx_car_test, len, CAR_LBL, TEST_DATA_NBR);
    printf("SGD_TANK_TEST\t");
    test_model(sgd_weights[0], img_mtrx_tank_test, len, TANK_LBL, TEST_DATA_NBR);
    printf("SGD_CAR_TRAIN\t");
    test_model(sgd_weights[0], img_mtrx_car_train, len, CAR_LBL, TRAIN_DATA_NBR);
    printf("SGD_TANK_TRAIN\t");
    test_model(sgd_weights[0], img_mtrx_tank_train, len, TANK_LBL, TRAIN_DATA_NBR);

    printf("SGD_CAR_TEST\t");
    test_model(sgd_weights[1], img_mtrx_car_test, len, CAR_LBL, TEST_DATA_NBR);
    printf("SGD_TANK_TEST\t");
    test_model(sgd_weights[1], img_mtrx_tank_test, len, TANK_LBL, TEST_DATA_NBR);
    printf("SGD_CAR_TRAIN\t");
    test_model(sgd_weights[1], img_mtrx_car_train, len, CAR_LBL, TRAIN_DATA_NBR);
    printf("SGD_TANK_TRAIN\t");
    test_model(sgd_weights[1], img_mtrx_tank_train, len, TANK_LBL, TRAIN_DATA_NBR);
    ...
    printf("SGD_CAR_TEST\t");
    test_model(sgd_weights[3], img_mtrx_car_test, len, CAR_LBL, TEST_DATA_NBR);
    printf("SGD_TANK_TEST\t");
    test_model(sgd_weights[3], img_mtrx_tank_test, len, TANK_LBL, TEST_DATA_NBR);
    printf("SGD_CAR_TRAIN\t");
    test_model(sgd_weights[3], img_mtrx_car_train, len, CAR_LBL, TRAIN_DATA_NBR);
    printf("SGD_TANK_TRAIN\t");
    test_model(sgd_weights[3], img_mtrx_tank_train, len, TANK_LBL, TRAIN_DATA_NBR);

    printf("SGD_CAR_TEST\t");
    test_model(sgd_weights[4], img_mtrx_car_test, len, CAR_LBL, TEST_DATA_NBR);
    printf("SGD_TANK_TEST\t");
    test_model(sgd_weights[4], img_mtrx_tank_test, len, TANK_LBL, TEST_DATA_NBR);
    printf("SGD_CAR_TRAIN\t");
    test_model(sgd_weights[4], img_mtrx_car_train, len, CAR_LBL, TRAIN_DATA_NBR);
    printf("SGD_TANK_TRAIN\t");
    test_model(sgd_weights[4], img_mtrx_tank_train, len, TANK_LBL, TRAIN_DATA_NBR);
